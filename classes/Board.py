...
3. Параметр hidden типа bool - информация о том, нужно ли скрывать кораблина доске (для вывода доски врага), или нет (для своей доски).
...
defeat - определяеь побуду при сравнении кол-ва оставшихся кораблей с общим кол-вом кораблей игрока или компьютера.
"""
